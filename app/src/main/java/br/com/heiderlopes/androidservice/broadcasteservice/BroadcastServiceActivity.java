...
public class BroadcastServiceActivity extends AppCompatActivity {
    public static final String mBroadcastStringAction = "br.com.heiderlopes.broadcast.string";
    public static final String mBroadcastIntegerAction = "br.com.heiderlopes.broadcast.integer";
    public static final String mBroadcastArrayListAction = "br.com.heiderlopes.broadcast.arraylist";
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (intent.getAction().equals(mBroadcastStringAction)) {
                ...
                mTextView.setText(mTextView.getText()
                        ...
                        + "\n\n");
                Intent stopIntent = new Intent(BroadcastServiceActivity.this,
